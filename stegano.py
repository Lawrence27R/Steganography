...
main.title('Steganography Image Encrypter/Decrypter')
...
head_label = Label(main, text="Steganography Text to Image Encrypter/Decrypter",
            bg='lavender', font=("Segoe UI Semibold", 30))
head_label.place(relx=0.3,rely=0.05)

head_label = Label(main, text='''Points to be Noted:
...
''',
            bg='lavender', font=("Times New Roman", 15),justify='left')
head_label.place(relx=0.48,rely=0.25)

encbuttonTIP=Button(text='Text in Image Encrypter',fg="black",bg="blue",width=25,command=encode_text)
encbuttonTIP['font'] =font_def 
encbuttonTIP.place(relx=0.1,rely=0.25)

decbuttonTIP=Button(text='Text in Image Decrypter',fg="black",bg="blue",width=25,command=decode_text)
decbuttonTIP['font'] =font_def 
decbuttonTIP.place(relx=0.1,rely=0.39)

encbuttonPIP=Button(text='Image in Image Encrypter',fg="black",bg="blue",width=25,command=encode_image)
encbuttonPIP['font'] =font_def 
encbuttonPIP.place(relx=0.1,rely=0.6)

decbuttonPIP=Button(text='Image in Image Decrypter',fg="black",bg="blue",width=25,command=decode_image)
